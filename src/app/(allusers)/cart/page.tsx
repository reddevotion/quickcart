                  ...
                  {Object.keys(cartItems).map((itemId : string, index: number) => {
                    ...
                    return (
                      <tr key={index}>
                        ...
                        <td className="py-4 md:px-4 px-1 text-gray-600">${product.offerPrice - 0.01}</td>
                      ...
                      <td className="py-4 md:px-4 px-1 text-gray-600">${Number(((product.offerPrice - 0.01) * cartItems[itemId]).toFixed(2))}</td>
                      </tr>
                    )
                  })}
              </tbody>
